...
(function (GStd) {
    var Scene = /** @class */ (function () {
        ...
        Scene.register = function (id, sceneType) {
        ...
        Scene.change = function (id, progress) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            typeInfo = this._sceneTypeMap[id];
                            if (!typeInfo) {
                            ...
                            return [4 /*yield*/, GStd.Resource.load3D(typeInfo.url, progress)];
                        case 1:
                            _a.sent();
                            this._curScene = GStd.Resource.getRes(typeInfo.url);
